# 5: Adding a sidebar, creating pages
...
###
my_page = st.sidebar.radio('Page Navigation', ['About the data', 'Interactive highlights',  'News summarization', 
                            'Sentiment-based recommendations', 'Keyword extraction'])
...
#         focused_summary_toggle = st.toggle(
#             'Make focused summary', value=False
#         )
...
#         summary_button = st.button('Summarize article')
        if summary_button:
